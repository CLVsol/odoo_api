...
if __name__ == '__main__':
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20151216_151202_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20151216_151202_I.TXT'
    # date_synchronization = '2015-12-16 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160111_160101_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160111_160101_I.TXT'
    # date_synchronization = '2016-01-11 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160203_160201_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160203_160201_I.TXT'
    # date_synchronization = '2016-02-03 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160225_160202_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160225_160202_I.TXT'
    # date_synchronization = '2016-02-25 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160301_160301_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160301_160301_I.TXT'
    # date_synchronization = '2016-03-01 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160315_160302_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160315_160302_I.TXT'
    # date_synchronization = '2016-03-15 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160324_160303_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160324_160303_I.TXT'
    # date_synchronization = '2016-03-24 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160329_160304_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160329_160304_I.TXT'
    # date_synchronization = '2016-03-30 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160412_160401_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160412_160401_I.TXT'
    # date_synchronization = '2016-04-12 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160422_160402_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160422_160402_I.TXT'
    # date_synchronization = '2016-04-22 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160429_160403_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160429_160403_I.TXT'
    # date_synchronization = '2016-04-29 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160513_160501_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160513_160501_I.TXT'
    # date_synchronization = '2016-05-13 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160527_160502_I.TXT'
    # print('--> Executing clv_insured_ext_syncronize_orizon(' + file_name + ')...')
    # clv_insured_ext_syncronize_orizon(client, file_name)

    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160527_160502_I.TXT'
    # date_synchronization = '2016-05-27 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
    ...
    # print('-->', client)
    # file_name = '/opt/openerp/orizon/USU1865_20160610_160601_I.TXT'
    # date_synchronization = '2016-06-10 21:00:00'
    # print('--> Executing clv_insured_ext_sync_confirm_orizon() for "' + file_name + '"...')
    # clv_insured_ext_sync_confirm_orizon(client, file_name, date_synchronization)
